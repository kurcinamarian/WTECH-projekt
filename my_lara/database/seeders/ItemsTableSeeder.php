...
class ItemsTableSeeder extends Seeder
{
    public function run()
    {
        DB::table('items')->insert([
            // KIDS produkty pre test filtrovania
            ...
            // Extra kombinácie pre test bitovej logiky
            ['item_name' => 'Kids Longsleeve Cozy+Formal Cotton+Polyester', 'price' => 38.80, 'description' => 'RandomWord', 'parameters' => 'xx', 'category_id' => 6, 'main_category' => 'KIDS', 'style_fabric' => 46, 'colour' => 'Red', 'times_bought' => 8, 'release_date' => '2025-03-28'],
            ...
            // Produkty pre dospelých (nemali by sa zobraziť na stránke KIDS)
            ...
            ['item_name' => 'Women Dress Green Cotton Wool', 'price' => 39.00, 'description' => 'RandomWord', 'parameters' => 'xx', 'category_id' => 14, 'main_category' => 'WOMEN', 'style_fabric' => 24, 'colour' => 'Green', 'times_bought' => 19, 'release_date' => '2025-02-10'],

            // Mixované štýly a materiály pre ďalšie testy
            ['item_name' => 'Kids Sport Shoe Casual+Cozy', 'price' => 33.00, 'description' => 'RandomWord', 'parameters' => 'xx', 'category_id' => 3, 'main_category' => 'KIDS', 'style_fabric' => 5, 'colour' => 'Blue', 'times_bought' => 7, 'release_date' => '2025-03-20'],
            ...
            ['item_name' => 'Kids Polyester Pants', 'price' => 28.90, 'description' => 'RandomWord', 'parameters' => 'xx', 'category_id' => 13, 'main_category' => 'KIDS', 'style_fabric' => 32, 'colour' => 'White', 'times_bought' => 17, 'release_date' => '2025-04-02'],
        ]);
    }
}
