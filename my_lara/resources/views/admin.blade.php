                    ...
                    <div class="list-group-item">
                        ...
                        <div class="collapse mt-3" id="collapseItem{{ $item->item_id }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="big_category" class="form-select">
                                            <option value="MEN" {{ $item->main_category === 'MEN' ? 'selected' : '' }}>
                                                MEN
                                            </option>
                                            <option
                                                value="WOMEN" {{ $item->main_category === 'WOMEN' ? 'selected' : '' }}>
                                                WOMEN
                                            </option>
                                            <option
                                                value="KIDS" {{ $item->main_category === 'KIDS' ? 'selected' : '' }}>
                                                KIDS
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="color" class="form-select">
                                            <option value="Red" {{ $item->colour == 'Red' ? 'selected' : '' }}>Red
                                            </option>
                            ...
                            <div class="container mt-3">
                                ...
                                <form action="{{ route('admin.items.updateImages', $item->item_id) }}" method="POST"
                        ...
                        <form method="POST" action="{{ route('items.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="newItemPrice" name="price"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="newItemDescription" name="description" rows="3"
                                              placeholder="Enter description" required></textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="newItemParameters" class="form-label">Parameters</label>
                                    <textarea class="form-control" id="newItemParameters" name="parameters" rows="3"
                            ...
                            <div class="mb-3">
                                <label class="form-label">Style</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="style[]" value="1"
                                           id="casual">
                                    <label class="form-check-label" for="casual">Casual</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="style[]" value="2"
                                           id="formal">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fabric[]" value="8"
                                           id="cotton">
                                    <label class="form-check-label" for="cotton">Cotton</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fabric[]" value="16"
                                           id="wool">
                                    <label class="form-check-label" for="wool">Wool</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fabric[]" value="32"
                                           id="polyester">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="newItemImages" name="images[]"
