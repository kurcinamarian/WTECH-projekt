                ...
                <div class="d-flex justify-content-between mb-4">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="orderByDropdown">
                            <li>
                                <a class="dropdown-item" href="{{ route('men', array_merge($query, ['sort' => 'price_asc'])) }}">
                                    Price - Low to High
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('men', array_merge($query, ['sort' => 'price_desc'])) }}">
                                    Price - High to Low
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('men', array_merge($query, ['sort' => 'popular'])) }}">
                                    Most Popular
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('men', array_merge($query, ['sort' => 'newest'])) }}">
                                    Newest
                                </a>
                            </li>
                        </ul>
